...
# Collect the Snowflake DataFrame into a Pandas DataFrame
pd_df = my_dataframe.collect()

# Convert the collected data to a Pandas DataFrame
pd_df = pd.DataFrame(pd_df)

# Display the Pandas DataFrame for debugging purposes
# st.dataframe(pd_df)
# st.stop()

# Create a list of fruit names for the multiselect options
